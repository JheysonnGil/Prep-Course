...
function tieneEmail(usuario) {
  ...
  // Tu código:
  switch (true) {
    case usuario.email == undefined:
      return false;
    case usuario.email == null:
      return false
    default:
      return true;
  }
...
function tienePropiedad(objeto, propiedad) {
  ...
  // Tu código:
  switch (true) {
    case objeto[propiedad] == undefined:
      return false;
    default:
      return true;
  }
...
function verificarPassword(usuario, password) {
  ...
  // // Tu código:
  switch (true) {
    case usuario['password'] == password:
      return true;
    default:
      return false;
  }
...
function sumarLikesDeUsuario(usuario) {
  ...
  for (var i = 0; i < usuario.posts.length; i++) {
    lik = parseInt(usuario.posts[i]['likes']);
    sum = lik + sum;
  }
  return sum;
}
